...
namespace Sales_web_MVC.Data
{
    public class SeedingService
    {
        ...
        public void seed()
        {
            ...
            Sellers s1 = new Sellers(1, "Haiders", "hd@gmail.com",
                new DateTime(1979, 8, 4), 7000.0, d1);
            Sellers s2 = new Sellers(2, "Wesley", "wesley@gmail.com",
                new DateTime(1999, 6, 7), 1800.0, d2);
            ...
            Sellers s6 = new Sellers(6, "Silvana", "silvana@gmail.com",
                new DateTime(1984, 04, 20), 2500.0, d4);
